...
const Canvas: React.FC = () => {
  ...
  const handleCanvasClick = (e: React.MouseEvent) => {
    // Ensure the click is directly on the canvas background, not on a component
    if (e.target === e.currentTarget || (e.target as HTMLElement).classList.contains('scroll-area-viewport') || (e.target as HTMLElement).classList.contains('canvas-main-div')) {
  ...
  return (
    ...
    >
      <ScrollArea className="h-full p-2 md:p-6 rounded-md scroll-area-viewport">
        <div className="max-w-4xl mx-auto bg-card p-4 md:p-8 rounded-lg shadow-xl min-h-[calc(100vh-10rem)] canvas-main-div">
